...
**Statut** : WAITING
**Specs de référence** : `specifications/08-report-engine.md` §6-7, `specifications/03-task-framework.md` §7.6
...
- [ ] Publishers dans `context/interfaces-registry.md` STABLE
