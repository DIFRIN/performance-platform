...
**Statut** : WAITING
**Specs de référence** : `architecture.md` §4, `specifications/02-execution-engine.md` §8, `specifications/04-agent-runtime.md` §6-7, `specifications/05-transport-layer.md` §3
**Dépend de** : PDR-001
...
- [ ] Les 18 events + signal dans `context/interfaces-registry.md`
