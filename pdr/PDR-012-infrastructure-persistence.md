...
**Statut** : WAITING
**Specs de référence** : `specifications/02-execution-engine.md` §2, `constraints.md` CNF-02, ADR-011
...
- [ ] `JpaExecutionRepository` dans `context/interfaces-registry.md` STABLE
