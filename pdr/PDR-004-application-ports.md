...
**Statut** : WAITING
**Specs de référence** : `architecture.md` §2-3, `specifications/02-execution-engine.md` §2, `specifications/04-agent-runtime.md` §3, `specifications/08-report-engine.md` §2
**Dépend de** : PDR-001
...
- [ ] Tous les ports dans `context/interfaces-registry.md` STABLE
