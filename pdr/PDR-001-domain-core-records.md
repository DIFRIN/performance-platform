...
**Statut** : WAITING
**Specs de référence** : `specifications/01-scenario-dsl.md` §6-7, `specifications/02-execution-engine.md` §3-5, `specifications/03-task-framework.md` §2, `specifications/04-agent-runtime.md` §4-7, `specifications/06-injection-gatling.md` §5, `specifications/07-assertion-framework.md` §3-6
**Dépend de** : rien
...
- [ ] Les records sont dans `context/interfaces-registry.md` avec statut STABLE
