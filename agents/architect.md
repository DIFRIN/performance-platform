...
- Des clarifications de spec (mises à jour dans les fichiers `specifications/`)
- Des décisions de conception dans `current-task.md` section "Décisions Locales"
- Des mises à jour de `architecture.md` si la structure change
...
4. Valider ou ajuster le découpage de `current-task.md`
...
- Une dépendance Maven non listée dans `constraints.md` est introduite
