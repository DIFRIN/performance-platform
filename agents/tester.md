...
- Documenter les cas de test dans `feature-summaries/README.md`
...
2. Lire `feature-summaries/README.md` pour les features déjà testées
...
À la fin de chaque phase testée, ajouter dans `feature-summaries/README.md` :
