...
|---|---|---|---|
| `ExecutionId` | ⬜ PLANNED | PDR-001 | ISSUE-001 |
| `ScenarioId` | ⬜ PLANNED | PDR-001 | ISSUE-001 |
| `TaskId` | ⬜ PLANNED | PDR-001 | ISSUE-001 |
| `AgentId` | ⬜ PLANNED | PDR-001 | ISSUE-001 |
| `MessageId` | ⬜ PLANNED | PDR-001 | ISSUE-001 |
| `EventId` | ⬜ PLANNED | PDR-001 | ISSUE-001 |
| `SignalId` | ⬜ PLANNED | PDR-001 | ISSUE-001 |
| `ReportId` | ⬜ PLANNED | PDR-001 | ISSUE-001 |
| `Phase` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `ExecutionMode` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `TaskStatus` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `PhaseStatus` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `ExecutionStatus` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `AgentState` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `TaskCompletionPolicy` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `LoadModelType` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `AssertionOperator` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `AssertionStatus` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `Verdict` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `PublicationTarget` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `ReportFormat` | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `TransportType` (sans GRPC) | ⬜ PLANNED | PDR-001 | ISSUE-002 |
| `ScenarioDefinition` | ⬜ PLANNED | PDR-001 | ISSUE-003 |
| `StepDefinition` | ⬜ PLANNED | PDR-001 | ISSUE-003 |
| `LoadModel` | ⬜ PLANNED | PDR-001 | ISSUE-003 |
| `RetryPolicy` | ⬜ PLANNED | PDR-001 | ISSUE-003 |
| `TaskResult` (String taskName) | ⬜ PLANNED | PDR-001 | ISSUE-004 |
| `ExecutionContext` | ⬜ PLANNED | PDR-001 | ISSUE-005 |
| `PartialExecutionContext` | ⬜ PLANNED | PDR-001 | ISSUE-005 |
| `ExecutionPlan` | ⬜ PLANNED | PDR-001 | ISSUE-006 |
| `ExecutionStep` | ⬜ PLANNED | PDR-001 | ISSUE-006 |
| `ExecutionState` | ⬜ PLANNED | PDR-001 | ISSUE-006 |
| `InjectionResult` | ⬜ PLANNED | PDR-001 | ISSUE-006 |
| `AssertionResult` | ⬜ PLANNED | PDR-001 | ISSUE-006 |
| `Evidence` | ⬜ PLANNED | PDR-001 | ISSUE-006 |
