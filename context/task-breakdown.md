...
> Une fois `progress.md` initialisé, ce fichier ne doit PLUS être lu par le Developer.
> Source de vérité → `progress.md` + `pdr/*.md` + `issues/*.md`
>
...
> Le System Designer produit ensuite les vrais PDRs et Issues dans `pdr/` et `issues/`.
>
> ⚠️ Ce fichier est un GUIDE, pas la source de vérité du plan.
> La source de vérité est `progress.md` + `pdr/*.md` + `issues/*.md`.
...
**Specs à lire** : `02-execution-engine.md` sections 3+4, `architecture.md` section 2  
...
**Specs à lire** : `02-execution-engine.md` sections 2+3, `architecture.md` section 3  
**Prérequis** : Phase 1 ✅
...
**Specs à lire** : `02-execution-engine.md` section 9, `skills/hexagonal-architecture.md`  
**Prérequis** : Tâche 2.2 ✅
...
Voir `agents/system-designer.md` pour le processus complet.
