...
**Statut** : WAITING
**Specs de référence** : `.claude/knowledge/specs/03-task-framework.md`, `.claude/knowledge/adr/ADR-013-spring-first-infrastructure.md`, `.claude/knowledge/adr/ADR-014-datasource-configuration.md`
