...
**Statut** : WAITING
**Specs de référence** : `.claude/knowledge/specs/03-task-framework.md` §1, §7.2, §7.8, `.claude/knowledge/constraints.md` CF-07, CF-08
**Dépend de** : PDR-001
...
- [ ] `@Preparation/@Injection/@Assertion` dans `.claude/context/interfaces-registry.md` STABLE
