...
**Statut** : WAITING
**Specs de référence** : `.claude/knowledge/architecture.md` §1, §5, `.claude/knowledge/specs/09-deployment.md` §1, ADR-005, ADR-006, `.claude/knowledge/constraints.md` CF-01
