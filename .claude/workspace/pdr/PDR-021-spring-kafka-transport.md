...
**Statut** : WAITING
**Specs de référence** : `.claude/knowledge/adr/ADR-009-kafka-consumer-group-per-agent.md`, `.claude/knowledge/adr/ADR-013-spring-first-infrastructure.md`, `.claude/knowledge/specs/05-transport-layer.md`
