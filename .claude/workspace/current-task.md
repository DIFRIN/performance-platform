...
> La SOURCE DE VÉRITÉ du plan est `.claude/workspace/progress.md` + `.claude/workspace/issues/ISSUE-XXX.md`.
>
> Le Developer lit `.claude/workspace/progress.md` pour choisir son Issue, puis `.claude/workspace/issues/ISSUE-XXX.md`
...
|---|---|
| `.claude/knowledge/specs/XX-nom.md` | sections X, Y uniquement |
| `.claude/knowledge/skills/nom.md` | complet |
...
- [ ] `.claude/workspace/interfaces-registry.md` mis à jour (PLANNED → IN PROGRESS)
- [ ] `.claude/session-state.md` mis à jour en fin de session

---

## Dépendances

**Prérequis STABLE** : [Voir `.claude/workspace/dependency-map.md` — tâche X.X]
...
> Micro-décisions prises pendant cette tâche. À copier dans `.claude/workspace/decisions-log.md`.
...
- [ ] `.claude/workspace/interfaces-registry.md` mis à jour (IN PROGRESS → STABLE après review)
- [ ] `.claude/workspace/decisions-log.md` mis à jour
- [ ] `.claude/session-state.md` mis à jour (section "Historique des Sessions")
- [ ] `.claude/workspace/progress.md` mis à jour (après APPROVED)
