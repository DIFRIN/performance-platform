...
| `DynamicKafkaListenerRegistry` | ✅ STABLE | PDR-021 | ISSUE-090 |
| `KafkaMessageCodec` | ✅ STABLE | PDR-008 | ISSUE-029 |
| `KafkaConsumerManager` | ❌ REMOVED | PDR-021 | ISSUE-091 (supprimé) |
...
|---|---|---|---|
| `DynamicKafkaListenerRegistry` | ✅ STABLE | PDR-021 | ISSUE-090 |
| `KafkaTransportBeans` | ✅ STABLE | PDR-021 | ISSUE-089,091 |
