...
> Une fois `.claude/progress.md` initialisé, ce fichier ne doit PLUS être lu par le Developer.
> Source de vérité → `.claude/progress.md` + `.claude/pdr/*.md` + `.claude/issues/*.md`
>
...
> Le System Designer produit ensuite les vrais PDRs et Issues dans `.claude/pdr/` et `.claude/issues/`.
>
> ⚠️ Ce fichier est un GUIDE, pas la source de vérité du plan.
> La source de vérité est `.claude/progress.md` + `.claude/pdr/*.md` + `.claude/issues/*.md`.
...
**Specs à lire** : `02-execution-engine.md` sections 3+4, `.claude/architecture.md` section 2  
...
**Specs à lire** : `02-execution-engine.md` sections 2+3, `.claude/architecture.md` section 3  
**Prérequis** : Phase 1 ✅
...
**Specs à lire** : `02-execution-engine.md` section 9, `.claude/skills/hexagonal-architecture.md`  
**Prérequis** : Tâche 2.2 ✅
