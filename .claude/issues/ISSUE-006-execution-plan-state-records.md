...
- [ ] `.claude/progress.md` mis à jour : ISSUE-006 → DONE
- [ ] `.claude/context/interfaces-registry.md` : `ExecutionPlan`, `ExecutionStep`, `ExecutionState`, `InjectionResult`, `AssertionResult`, `Evidence` → STABLE
