...
> La SOURCE DE VÉRITÉ du plan est `.claude/progress.md` + `.claude/issues/ISSUE-XXX.md`.
>
> Le Developer lit `.claude/progress.md` pour choisir son Issue, puis `.claude/issues/ISSUE-XXX.md`
...
|---|---|
| `.claude/specifications/XX-nom.md` | sections X, Y uniquement |
| `.claude/skills/nom.md` | complet |
...
- [ ] `.claude/context/interfaces-registry.md` mis à jour (PLANNED → IN PROGRESS)
...
**Prérequis STABLE** : [Voir `.claude/context/dependency-map.md` — tâche X.X]
...
> Micro-décisions prises pendant cette tâche. À copier dans `.claude/context/decisions-log.md`.
...
- [ ] `.claude/context/interfaces-registry.md` mis à jour (IN PROGRESS → STABLE après review)
- [ ] `.claude/context/decisions-log.md` mis à jour
- [ ] `.claude/session-state.md` mis à jour (section "Historique des Sessions")
- [ ] `.claude/feature-summaries/README.md` mis à jour (après APPROVED)
